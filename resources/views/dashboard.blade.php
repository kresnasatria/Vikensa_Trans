...
<aside
    ...
    class="fixed inset-y-0 left-0 z-50 flex w-[280px] flex-col border-r border-white/10 bg-slate-950 text-white transition-transform duration-300 lg:translate-x-0"
>
    ...
    <div class="flex h-24 items-center justify-between border-b border-white/10 px-6">
        ...
        <button
            @click="sidebarOpen = false"
            type="button"
            class="flex h-10 w-10 items-center justify-center rounded-xl text-slate-400 transition hover:bg-white/10 hover:text-white lg:hidden"
        >
            <svg
                viewBox="0 0 24 24"
                fill="none"
    ...
    <nav class="flex-1 overflow-y-auto px-4 py-6">
        ...
        <p class="mb-3 px-4 text-[10px] font-black uppercase tracking-[.2em] text-slate-500">
            Menu Utama
        </p>

        <a
            href="{{ route('dashboard') }}"
            class="flex items-center gap-3 rounded-2xl bg-sky-500 px-4 py-3.5 text-sm font-bold text-white shadow-lg shadow-sky-500/10"
        >
        ...
        <a
            href="{{ route('riwayat') }}"
            class="mt-2 flex items-center gap-3 rounded-2xl px-4 py-3.5 text-sm font-semibold text-slate-400 transition hover:bg-white/5 hover:text-white"
        >
        ...
        @if((Auth::user()->role ?? null) === 'admin')
            ...
            <p class="mb-3 mt-8 px-4 text-[10px] font-black uppercase tracking-[.2em] text-slate-500">
                Administrator
            </p>

            <a
                href="{{ route('admin.dashboard') }}"
                class="flex items-center gap-3 rounded-2xl px-4 py-3.5 text-sm font-semibold text-slate-400 transition hover:bg-white/5 hover:text-white"
            >
    ...
    <div class="border-t border-white/10 p-4">
        ...
        <div x-data="{ profileOpen: false }" class="relative">
            ...
            <button
                ...
                type="button"
                class="flex w-full items-center gap-3 rounded-2xl p-3 text-left transition hover:bg-white/5"
            >
            ...
            <div
                ...
                x-transition
                class="absolute bottom-full left-0 right-0 mb-2 overflow-hidden rounded-2xl border border-slate-200 bg-white p-2 shadow-2xl"
            >

                <a
                    href="{{ route('profile.edit') }}"
                    class="block rounded-xl px-4 py-3 text-sm font-semibold text-slate-600 transition hover:bg-slate-50"
                >
                    Edit Profil
                </a>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button
                        type="submit"
                        class="block w-full rounded-xl px-4 py-3 text-left text-sm font-semibold text-red-500 transition hover:bg-red-50"
                    >
                        Keluar
                    </button>
        ...
        <div class="flex w-full items-center justify-between gap-5">
            ...
            <div class="flex items-center gap-4">
                ...
                <button
                    ...
                    type="button"
                    class="flex h-11 w-11 items-center justify-center rounded-xl border border-slate-200 text-slate-600 transition hover:bg-slate-50 lg:hidden"
                >
                    <svg
                        viewBox="0 0 24 24"
                        fill="none"
            ...
            <div class="flex items-center gap-3">
                ...
                <a
                    href="{{ route('riwayat') }}"
                    class="hidden items-center gap-2 rounded-xl border border-slate-200 px-4 py-2.5 text-sm font-bold text-slate-600 transition hover:border-sky-200 hover:bg-sky-50 hover:text-sky-600 sm:flex"
                >
        ...
        <div class="mx-auto max-w-7xl">
            ...
            @if(session('success'))
                ...
                <div class="mb-7 flex items-center gap-3 rounded-2xl border border-emerald-200 bg-emerald-50 px-5 py-4 text-sm font-semibold text-emerald-700">
                    ...
                    <span class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-emerald-100">
                        ✓
                    </span>
            ...
            <section
                class="relative overflow-hidden rounded-[2rem] bg-gradient-to-r from-slate-950 via-slate-900 to-blue-950 px-6 py-9 text-white sm:px-9 lg:px-11 lg:py-11"
            >
                ...
                <div class="relative z-10 flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
                    ...
                    <a
                        href="#pilih-armada"
                        class="inline-flex shrink-0 items-center justify-center gap-3 rounded-2xl bg-sky-500 px-6 py-4 text-sm font-black text-white shadow-xl shadow-sky-500/20 transition hover:-translate-y-1 hover:bg-sky-400"
                    >
            ...
            <section class="mt-7 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="dashboard-card rounded-3xl border border-slate-200 bg-white p-6">
                    ...
                    <div class="mt-3 flex items-end justify-between">
                        ...
                        <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-50 font-black text-emerald-600">
                            ✓
                        </div>
            ...
            <section id="pilih-armada" class="mt-12">
                ...
                <div class="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
                    ...
                    <div>
                        ...
                        <p class="text-xs font-black uppercase tracking-[.18em] text-sky-600">
                            Armada VikensaTrans
                        </p>
                        ...
                        <p class="mt-2 max-w-2xl text-sm leading-7 text-slate-500">
                            Pilih unit kendaraan yang masih tersedia. Detail kota jemput, tujuan, serta waktu keberangkatan akan diisi pada form pemesanan.
                        </p>
                ...
                <div class="mt-7 grid gap-7 xl:grid-cols-2">
                    ...
                    @forelse($schedules as $schedule)
                        ...
                        @php
                            ...
                            $vehicleImage = $firstPhoto
                                ? asset('storage/' . $firstPhoto->photo_path)
                                : asset('images/v01.jpeg');
                        @endphp

                        <article
                            class="dashboard-card relative flex flex-col overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition-all duration-300"
                            :class="showGallery ? '!transform-none !shadow-sm pointer-events-auto' : ''"
                            ...
                            x-data="{
                                ...
                                photos: @js(
                                    ($schedule->shuttle->photos ?? collect())
                                        ->map(fn($photo) => asset('storage/' . $photo->photo_path))
                                        ->values()
                                ),
                                ...
                                openPreview(index) {
                                    ...
                                    this.previewImage = this.photos[index];
                                },
                                ...
                                nextPreview() {
                                    ...
                                    this.previewIndex =
                                        (this.previewIndex + 1) % this.photos.length;

                                    this.previewImage =
                                        this.photos[this.previewIndex];
                                },
                        ...
                        >
                            ...
                            <div class="relative h-[240px] shrink-0 overflow-hidden bg-slate-200 sm:h-[280px]">
                                ...
                                <img
                                    src="{{ $vehicleImage }}"
                                    alt="{{ $schedule->shuttle->name ?? 'Armada' }}"
                                ...
                                <div class="absolute bottom-5 left-5 right-5">
                                    ...
                                    <p class="text-xs font-bold uppercase tracking-[.15em] text-sky-300">
                                        VikensaTrans
                                    </p>
                            ...
                            <div class="flex flex-1 flex-col p-6 sm:p-7">
                                ...
                                <div class="flex items-start justify-between gap-4 border-b border-slate-100 pb-5">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-2xl font-black text-sky-600">
                                ...
                                <div class="mt-5">
                                    ...
                                    <p class="text-sm leading-6 text-slate-500">
                                        ...
                                        <span class="font-bold text-slate-700">
                                            {{ $schedule->shuttle->seat_capacity }} orang penumpang
                                        </span>.

                                        Kendaraan ini sangat cocok dan nyaman untuk menemani perjalanan Anda dengan rute fleksibel yang bisa ditentukan sendiri.
                                ...
                                <div class="mt-6 grid gap-3 sm:grid-cols-2">
                                    ...
                                    <div class="flex items-center gap-3 rounded-2xl bg-slate-50 p-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-1 text-sm font-black text-slate-900">
                                                {{ $schedule->shuttle->seat_capacity ?? '-' }} Penumpang
                                            </p>
                                ...
                                <div class="mt-4">
                                    ...
                                    <button
                                        ...
                                        type="button"
                                        class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-sky-50 px-5 py-3 text-sm font-bold text-sky-600 transition hover:bg-sky-100"
                                    >
                                ...
                                <div>
                                    ...
                                    @if($schedule->is_available)
                                        ...
                                        <a
                                            href="{{ route('book.create', $schedule->id) }}"
                                            class="group flex w-full items-center justify-center gap-3 rounded-2xl bg-slate-950 px-6 py-4 text-sm font-black text-white shadow-xl shadow-slate-900/10 transition hover:-translate-y-0.5 hover:bg-sky-600"
                                        >
                                    ...
                                    @else
                                        ...
                                        <button
                                            type="button"
                                            disabled
                                            class="flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-2xl bg-slate-100 px-6 py-4 text-sm font-black text-slate-400"
                                        >
                                            Unit Sedang Disewa
                                        </button>
                            ...
                            >
                                ...
                                <div
                                    ...
                                    "
                                    class="flex w-full max-w-4xl flex-col overflow-hidden rounded-3xl bg-white p-6 shadow-2xl sm:max-h-[90vh]"
                                >
                                    ...
                                    <div class="mb-4 flex shrink-0 items-center justify-between border-b border-slate-100 pb-4">
                                        ...
                                        <button
                                            ...
                                            type="button"
                                            class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 font-bold text-slate-500 transition hover:bg-red-100 hover:text-red-500"
                                        >
                                    ...
                                    <div class="grid grid-cols-1 gap-4 overflow-y-auto p-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                        ...
                                        @forelse($schedule->shuttle->photos ?? [] as $photo)
                                            ...
                                            <button
                                                ...
                                                class="group relative aspect-square cursor-zoom-in overflow-hidden rounded-2xl border border-slate-200 bg-slate-100 text-left"
                                            >

                                                <img
                                                    src="{{ asset('storage/' . $photo->photo_path) }}"
                                                    alt="Foto {{ $schedule->shuttle->name }}"
                                                    class="h-full w-full object-cover transition duration-500 group-hover:scale-110 group-hover:brightness-75"
                                                >

                                                <div class="pointer-events-none absolute inset-0 flex items-center justify-center opacity-0 transition duration-300 group-hover:opacity-100">

                                                    <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white/90 text-slate-800 shadow-xl">
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        class="absolute right-4 top-4 z-30 flex h-12 w-12 items-center justify-center rounded-full bg-white/10 text-white backdrop-blur-md transition hover:bg-white/20 sm:right-7 sm:top-7"
                                    ...
                                    <div
                                        ...
                                        class="absolute left-1/2 top-5 z-30 -translate-x-1/2 rounded-full bg-white/10 px-4 py-2 text-xs font-bold text-white backdrop-blur-md sm:top-7"
                                    >
                                    ...
                                    <button
                                        ...
                                        class="absolute left-3 z-30 flex h-12 w-12 items-center justify-center rounded-full bg-white/10 text-white backdrop-blur-md transition hover:scale-105 hover:bg-white/20 sm:left-7 sm:h-14 sm:w-14"
                                    ...
                                    <button
                                        ...
                                        class="absolute right-3 z-30 flex h-12 w-12 items-center justify-center rounded-full bg-white/10 text-white backdrop-blur-md transition hover:scale-105 hover:bg-white/20 sm:right-7 sm:h-14 sm:w-14"
                                    ...
                                    {{-- FOTO BESAR --}}
                                    <div
                                        class="relative z-10 flex max-h-[92vh] max-w-[95vw] items-center justify-center px-12 sm:px-20"
                                        @click.stop
                                    >

                                        <img
                                            :src="previewImage"
                                            alt="Preview foto unit"
                                            class="max-h-[92vh] max-w-[95vw] rounded-2xl object-contain shadow-2xl"
                                        >
                    ...
                    @empty
                        ...
                        <div class="col-span-full rounded-[2rem] border border-dashed border-slate-300 bg-white px-6 py-16 text-center">
                            ...
                            <p class="mt-2 text-sm text-slate-400">
                                Silakan tambahkan unit armada baru melalui panel admin.
                            </p>
                ...
                <div class="rounded-[2rem] border border-slate-200 bg-white p-6 sm:p-8">
                    ...
                    <div class="mt-7 grid gap-4 sm:grid-cols-3">
                        ...
                        <div class="rounded-2xl bg-slate-50 p-5">
                            ...
                            <p class="mt-2 text-xs leading-6 text-slate-500">
                                Tentukan lokasi jemput, tujuan, serta waktu perjalanan.
                            </p>
                ...
                <div class="relative overflow-hidden rounded-[2rem] bg-sky-600 p-7 text-white sm:p-8">
                    ...
                    <div class="relative">
                        ...
                        <p class="mt-3 text-sm leading-7 text-sky-100">
                            Cek status pembayaran dan seluruh riwayat perjalanan VikensaTrans milikmu.
                        </p>

                        <a
                            href="{{ route('riwayat') }}"
                            class="mt-7 inline-flex items-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-black text-sky-600 transition hover:-translate-y-0.5"
                        >
                            Lihat Riwayat →
                        </a>
