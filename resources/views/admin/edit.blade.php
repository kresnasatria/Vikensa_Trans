...
<head>
    ...
    <meta name="description" content="Edit Armada & Jadwal - Administrator VikensaTrans">
...
<body class="bg-slate-100 text-slate-900 antialiased" x-data="{ sidebarOpen: false }">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 flex w-[285px] flex-col border-r border-white/10 bg-slate-950 text-white transition-transform duration-300 lg:translate-x-0">
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-6">
            ...
            <a href="{{ route('admin.create') }}" class="mt-2 flex items-center gap-3 rounded-2xl px-4 py-3.5 text-sm font-semibold text-slate-400 transition hover:bg-white/5 hover:text-white">
                <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-white/5">
            ...
            <div class="mt-2 flex items-center gap-3 rounded-2xl bg-sky-500 px-4 py-3.5 text-sm font-bold text-white shadow-lg shadow-sky-500/10">
                <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-white/15">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" class="h-5 w-5"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L8 18l-4 1 1-4Z"/></svg>
                </div>
                Edit Armada
            </div>
            ...
            <div class="mt-9 rounded-3xl border border-white/10 bg-white/[.04] p-5">
                ...
                <p class="mt-4 text-sm font-black text-white">Mode Edit</p>
                <p class="mt-2 text-xs leading-6 text-slate-500">Perubahan yang disimpan akan langsung memperbarui informasi armada dan jadwal pada database VikensaTrans.</p>
            </div>
        </nav>
    ...
    <div class="lg:pl-[285px]">
        ...
        <main class="px-5 py-8 sm:px-7 lg:px-10 lg:py-10">
            <div class="mx-auto max-w-6xl">
                ...
                <div class="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
                    <div>
                        <div class="inline-flex items-center gap-2 rounded-full bg-amber-100 px-4 py-2 text-xs font-black uppercase tracking-[.15em] text-amber-700">
                            Edit Data
                        </div>
                        ...
                        <p class="mt-3 max-w-2xl text-sm leading-7 text-slate-500">
                            Sesuaikan informasi armada, harga, dan status ketersediaannya.
                        </p>
                    </div>
                    <div class="inline-flex w-fit items-center gap-2 rounded-full bg-white px-4 py-2 text-xs font-semibold text-slate-500 shadow-sm ring-1 ring-slate-200">
                        ...
                        {{ $schedule->is_available ? 'Unit tersedia' : 'Unit sedang disewa' }}
                    </div>
                </div>
                ...
                @if($errors->any())
                    <div class="mt-7 rounded-2xl border border-red-200 bg-red-50 p-5">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="font-black text-red-700">Perubahan belum dapat disimpan</p>
                ...
                {{-- EDIT FORM --}}
                <form action="{{ route('admin.update', $schedule->id) }}" method="POST" class="mt-8">
                    @csrf
                    @method('PUT')
                            ...
                            <section class="form-card overflow-hidden rounded-[2rem] border border-slate-200 bg-white">
                                <div class="flex items-center gap-4 border-b border-slate-100 px-6 py-5 sm:px-7">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs text-slate-400">Sesuaikan nama dan kapasitas kendaraan.</p>
                                    </div>
                                </div>
                                ...
                                <div class="grid gap-5 p-6 sm:p-7 md:grid-cols-2">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div class="relative mt-2">
                                            ...
                                            <input id="shuttle_name" type="text" name="shuttle_name" value="{{ old('shuttle_name', $schedule->shuttle->name) }}" required placeholder="Contoh: Toyota Hiace" class="block h-14 w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-12 pr-4 text-sm font-medium text-slate-900 outline-none transition placeholder:text-slate-400 hover:border-slate-300 focus:border-sky-500 focus:bg-white focus:ring-4 focus:ring-sky-500/10">
                                        </div>
                                  ...
                                  {{-- PLAT NOMOR (EDITABLE) --}}
                                    <div>
                                        <label for="license_plate" class="block text-sm font-bold text-slate-700">
                                        ...
                                        <div class="relative mt-2">
                                            ...
                                            <input 
                                                ...
                                                type="text" 
                                                name="license_plate" 
                                                value="{{ old('license_plate', $schedule->shuttle->license_plate) }}" 
                                                required 
                                                placeholder="Contoh: B 1234 XYZ" 
                                                class="block h-14 w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-12 pr-4 text-sm font-black uppercase text-slate-900 outline-none transition placeholder:font-medium placeholder:normal-case placeholder:text-slate-400 hover:border-slate-300 focus:border-sky-500 focus:bg-white focus:ring-4 focus:ring-sky-500/10"
                                            >
                                        </div>
                                        @error('license_plate') 
                                    ...
                                    <div>
                                        ...
                                        <div class="relative mt-2">
                                            ...
                                            <input id="seat_capacity" type="number" name="seat_capacity" value="{{ old('seat_capacity', $schedule->shuttle->seat_capacity) }}" min="1" required class="block h-14 w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-12 pr-16 text-sm font-medium text-slate-900 outline-none transition hover:border-slate-300 focus:border-sky-500 focus:bg-white focus:ring-4 focus:ring-sky-500/10">
                            ...
                            <section class="form-card overflow-hidden rounded-[2rem] border border-slate-200 bg-white">
                                <div class="flex items-center gap-4 border-b border-slate-100 px-6 py-5 sm:px-7">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs text-slate-400">Perbarui harga dasar sewa dan status armada.</p>
                                    </div>
                                </div>
                                ...
                                <div class="grid gap-5 p-6 sm:p-7 md:grid-cols-2">
                                    {{-- HARGA --}}
                                    <div>
                                        <label for="price" class="block text-sm font-bold text-slate-700">Harga Sewa <span class="text-red-500">*</span></label>
                                        <div class="relative mt-2">
                                            ...
                                            <input id="price" type="number" name="price" value="{{ old('price', $schedule->price) }}" min="0" step="1000" required class="block h-14 w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-12 pr-4 text-sm font-medium text-slate-900 outline-none transition hover:border-slate-300 focus:border-sky-500 focus:bg-white focus:ring-4 focus:ring-sky-500/10">
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative mt-2">
                                            <select id="is_available" name="is_available" required class="appearance-none block h-14 w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-4 pr-12 text-sm font-medium text-slate-900 outline-none transition hover:border-slate-300 focus:border-sky-500 focus:bg-white focus:ring-4 focus:ring-sky-500/10">
                            ...
                            <div class="sticky top-28 space-y-5">
                                ...
                                <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white">
                                    <div class="bg-slate-950 px-6 py-6 text-white">
                                        <p class="text-xs font-black uppercase tracking-[.18em] text-sky-400">Data Saat Ini</p>
                                        <h3 class="mt-2 text-xl font-black">{{ $schedule->shuttle->name }}</h3>
                                        <p class="mt-2 text-xs text-slate-400">ID Jadwal #{{ $schedule->id }}</p>
                                    </div>

                                    <div class="divide-y divide-slate-100">
                                        <div class="flex items-center justify-between gap-4 px-6 py-4">
                                            <span class="text-xs font-semibold text-slate-400">Plat Nomor</span>
                                            <span class="text-sm font-black uppercase text-slate-800">{{ $schedule->shuttle->license_plate }}</span>
                                        </div>
                                        <div class="flex items-center justify-between gap-4 px-6 py-4">
                                            <span class="text-xs font-semibold text-slate-400">Kapasitas</span>
                                            <span class="text-sm font-black text-slate-800">{{ $schedule->shuttle->seat_capacity }} orang</span>
                                        </div>
                                        <div class="flex items-center justify-between gap-4 px-6 py-4">
                                            <span class="text-xs font-semibold text-slate-400">Harga</span>
                                            <span class="text-sm font-black text-sky-600">Rp {{ number_format($schedule->price, 0, ',', '.') }}</span>
                                        </div>
                                        <div class="flex items-center justify-between gap-4 px-6 py-4">
                                            <span class="text-xs font-semibold text-slate-400">Status</span>
                                            @if($schedule->is_available)
                                                <span class="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-2 text-[10px] font-black text-emerald-600">
                                                    <span class="h-2 w-2 rounded-full bg-emerald-500"></span>TERSEDIA
                                                </span>
                                            @else
                                                <span class="inline-flex items-center gap-2 rounded-full bg-red-50 px-3 py-2 text-[10px] font-black text-red-500">
                                                    <span class="h-2 w-2 rounded-full bg-red-500"></span>DISEWA
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="rounded-[2rem] border border-amber-200 bg-amber-50 p-5">
                                    <div class="flex gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-black text-amber-900">Pastikan perubahan benar</p>
                                            <p class="mt-2 text-xs leading-6 text-amber-700">Perubahan harga dan status akan langsung terlihat pada data yang digunakan sistem setelah disimpan.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="rounded-[2rem] border border-slate-200 bg-white p-5">
                                    <button type="submit" class="group flex w-full items-center justify-center gap-3 rounded-2xl bg-sky-500 px-6 py-4 text-sm font-black text-white shadow-xl shadow-sky-500/20 transition duration-300 hover:-translate-y-0.5 hover:bg-sky-400">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-5 w-5"><path d="M5 12h14"/><path d="m13 6 6 6-6 6"/></svg>
                                        Simpan Perubahan
                                    </button>
        ...
        {{-- FOOTER --}}
        <footer class="mt-12 border-t border-slate-200 px-5 py-7 sm:px-7 lg:px-10">
